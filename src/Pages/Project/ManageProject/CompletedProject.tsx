...
import { getAllCompletedProjects } from "../../../services/Project/ProjectServices";
import ProjetTerminé from "../../../components/Tables/projets/ProjetTerminé";
type TSubordinate = {
  id: string;
  name: string;
  email: string;
...
const Archivedprojects = () => {
 ...
 const fetchProject = async () => {
  ...
  if (hab?.project?.watchAllProject) {
    ...
    const project = await getAllCompletedProjects(
      page?.pageNumber,
      page?.pageSize,
      search?.title,
      userSelectedName,
      ...
      <div className="mx-2 py-4 md:mx-10 ">
        <>
          <div className="flex flex-col md:flex-row">
            <Breadcrumb
              paths={[{ name: "Liste des Projets Términés", to: "/gmp/project/projetterminés" }]}
            />
