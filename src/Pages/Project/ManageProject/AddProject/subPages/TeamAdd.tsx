      ...
      <div className="space-y-4 grid md:max-h-125 md:min-h-150 ">
        ...
        <div className="flex justify-end gap-3">
          <button
            ...
            className="md:w-fit max-h-10 gap-2 w-full cursor-pointer mt-2 py-2 px-5  text-center font-semibold text-zinc-700 hover:bg-zinc-50 lg:px-8 xl:px-5 border border-zinc-300 rounded-lg dark:border-secondaryGreen dark:bg-secondaryGreen dark:hover:bg-opacity-90"
          >
            Précédent
          </button>
          <button
