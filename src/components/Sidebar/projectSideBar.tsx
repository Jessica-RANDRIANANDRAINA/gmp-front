...
const ProjectSideBar = ({
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 text-sm flex h-screen w-72.5 flex-col overflow-y-hidden bg-boxlight  bg-cover duration-300 ease-linear dark:bg-boxdark dark:border-r-formStrokedark dark:border-r   ${
        ...
        <nav className="mt-5 h-full py-4 px-4 lg:mt-9 lg:px-6 flex flex-col ">
          ...
          <div className={`${isProjectHabilitate ? "" : "hidden"}`}>
            ...
            <ul>
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/gmp/project" || pathname.includes("project")
                }
              >
                {(handleClick, open) => {
                  return (
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          >
                           ...
                           <li>
                            <NavLink
                              to="/gmp/project/projetterminés"
                              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-tertiaryGreen dark:hover:bg-meta-4  ${
                                pathname.includes("gmp/project/projetterminés") &&
                                "bg-tertiaryGreen dark:bg-secondaryGreen"
                              }`}
                            >
                              <svg
          ...
          <div className={`${isProjectHabilitate ? "" : "hidden"}`}>
            <ul>
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/gmp/activity" || pathname.includes("activity")
                }
              >
                {(handleClick, open) => {
                  return (
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-tertiaryGreen dark:hover:bg-meta-4  ${
                                pathname.includes(
                                  `activity/${decodedToken?.jti}/list`
                                ) && "bg-tertiaryGreen dark:bg-secondaryGreen"
                              }`}
                            >
                              <svg
          ...
          {/*======== Menu Retour Utilisateur ==========*/}
          <div className="mb-2">
            <ul>
              <li>
                <NavLink
                  to="https://forms.office.com/Pages/ResponsePage.aspx?id=-XpV8LQDtEOewLTIAQ7PtxRG2Hzuf_xKuAAzDKwnY19UODFCOEdBMjZMQTlRNzYzWUtNOURXRE5CSi4u"
                  className={`gap-2.5 rounded-sm font-medium text-bodydark1 duration-300 ease-in-out hover:bg-tertiaryGreen dark:hover:bg-meta-4 ${
                    pathname.includes("https://forms.office.com/Pages/ResponsePage.aspx?id=-XpV8LQDtEOewLTIAQ7PtxRG2Hzuf_xKuAAzDKwnY19UODFCOEdBMjZMQTlRNzYzWUtNOURXRE5CSi4u") &&
                    "bg-tertiaryGreen dark:bg-secondaryGreen"
                  }`}
                >
                <a
                    href="https://forms.office.com/Pages/ResponsePage.aspx?id=-XpV8LQDtEOewLTIAQ7PtxRG2Hzuf_xKuAAzDKwnY19UODFCOEdBMjZMQTlRNzYzWUtNOURXRE5CSi4u"
                   className="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-tertiaryGreen dark:hover:bg-meta-4"
                  >
                  <svg
                    className="fill-current"
